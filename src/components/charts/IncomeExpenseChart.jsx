...
// Custom tooltip renderer matching premium design variables
    ...
    <Card title="Monthly Cash Flow Overview">
      <ResponsiveContainer width="100%" height={300}>
        <BarChart data={chartData} margin={{ top: 10, right: 10, left: 0, bottom: 5 }}>
          ...
          <Bar name="Income" dataKey="Income" fill="url(#analyticsIncomeGrad)" radius={[6, 6, 0, 0]} />
          <Bar name="Expenses" dataKey="Expenses" fill="url(#analyticsExpenseGrad)" radius={[6, 6, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </Card>
  );
